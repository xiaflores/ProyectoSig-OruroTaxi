...
public class DetailRequestActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTextViewRate=findViewById(R.id.txtViewRate);
        ...
        mGoogleApiProvider.getDirections(mOriginLatlng,mDestinationLatlng).enqueue(new Callback<String>() {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                ...
                try {
                    ...
                    String[] rateText=distanceText.split(" ");
                    rate =Double.parseDouble(rateText[0]);

                    mTextViewTime.setText(durationText);
                    mTextViewDistance.setText(distanceText);
                    if(rate>0 && rate<=1){
                        mTextViewRate.setText("Bs. 5 - 8");
                    }
                    else if(rate>1 && rate<=5){
                        mTextViewRate.setText("Bs. 10 - 15");
                    }
                    else if(rate>5){
                        mTextViewRate.setText("Bs. 15 - 30");
                    }
